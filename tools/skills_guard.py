...
Trust levels:
  - builtin:   Ships with Hades. Never scanned, always trusted.
...
THREAT_PATTERNS = [
    ...
    (r'\$HOME/\.(?:hermes|hades)/\.env|\~/\.(?:hermes|hades)/\.env',
     "hermes_env_access", "critical", "exfiltration",
     "directly references Hermes/Hades secrets file"),
    ...
    (r'\.(?:hermes|hades)/config\.yaml|\.(?:hermes|hades)/SOUL\.md',
     "hermes_config_mod", "critical", "persistence",
     "references Hermes/Hades configuration files directly"),
