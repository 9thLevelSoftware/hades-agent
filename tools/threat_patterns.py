...
_PATTERNS: List[Tuple[str, str, str]] = [
    ...
    (r'\$HOME/\.(?:hades|hermes)/\.env|\~/\.(?:hades|hermes)/\.env', "hermes_env", "strict"),
    ...
    (r'(update|modify|edit|write|change|append|add\s+to)\s+[^\n]{0,2048}\.(?:hades|hermes)/(config\.yaml|SOUL\.md)', "hermes_config_mod", "strict"),
...
def scan_for_threats(content: str, scope: str = "context") -> List[str]:
    ...
    # bypassing keyword checks (e.g. ``ｃａｔ ~/.hades/.env``).  NOTE: this
