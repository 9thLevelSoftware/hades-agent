...
Built for [Hades Agent](https://github.com/9thLevelSoftware/hades-agent). Usable in any coding agent. Canonical source lives here; synced to [`9thLevelSoftware/hades-agent/skills/creative/ascii-video`](https://github.com/9thLevelSoftware/hades-agent/tree/main/skills/creative/ascii-video) via PR.
