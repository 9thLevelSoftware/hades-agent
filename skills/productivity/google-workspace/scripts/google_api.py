#!/usr/bin/env python3
"""Google Workspace API CLI for Hades Agent.
...
from _hermes_home import get_hades_home
...
def _gws_binary() -> str | None:
    override = os.getenv("HADES_GWS_BIN")
    if override:
        return override
...
def main():
    parser = argparse.ArgumentParser(description="Google Workspace API for Hades Agent")
