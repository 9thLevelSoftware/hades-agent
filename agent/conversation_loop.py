...
from hades_constants import PARTIAL_STREAM_STUB_ID, env_get
                ...
                try:
                    ...
                    if has_hook("pre_api_request"):
                        ...
                        try:
                            ...
                            _runtime_record = public_runtime_binding(agent)
                        except Exception:
                            _runtime_record = {}
                        _runtime_event = _runtime_record.get("event")
                        if not isinstance(_runtime_event, dict):
                            _runtime_event = {}
                        _invoke_hook(
                            "pre_api_request",
                            task_id=effective_task_id,
                            ...
                            api_request_id=api_request_id,
                            session_id=agent.session_id or "",
                            decision_id=_runtime_record.get("decision_id"),
                            runtime_id=_runtime_event.get("runtime_id"),
