...
def register_from_config(
    ...
    *,
    ...
    ``cfg`` is the full parsed config dict (``hades_cli.config.load_config``
...
def _parse_response(event: str, stdout: str) -> Optional[Dict[str, Any]]:
    ...
    :func:`hades_cli.plugins.get_pre_tool_call_block_message`.  This is
...
def allowlist_path() -> Path:
    ...
    return get_hades_home() / ALLOWLIST_FILENAME
...
def run_once(
    ...
    ``kwargs`` is the same dict that :func:`hades_cli.plugins.invoke_hook`
