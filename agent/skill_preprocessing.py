...
_SKILL_TEMPLATE_RE = re.compile(r"\$\{(HERMES_SKILL_DIR|HADES_SESSION_ID)\}")
...
def substitute_template_vars(
    ...
    """Replace ${HERMES_SKILL_DIR} / ${HADES_SESSION_ID} in skill content.
    ...
    def _replace(match: re.Match) -> str:
        ...
        if token == "HADES_SESSION_ID" and session_id:
