...
from hades_cli.auth import AuthError, _read_codex_tokens, resolve_codex_runtime_credentials
...
def build_nous_credits_snapshot(account_info) -> Optional[AccountUsageSnapshot]:
    ...
    """
    try:
        from hades_cli.nous_account import nous_portal_topup_url
...
def _resolve_codex_usage_credentials(
    ...
    state, then the credential pool.  Hades's native OAuth setup now stores
