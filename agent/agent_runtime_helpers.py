...
def dump_api_request_debug(
    ...
    *,
    ...
    try:
        ...
        # originate from untrusted input (X-Hades-Session-Id header), and an
...
def anthropic_prompt_cache_policy(
    ...
    *,
    ...
    if eff_provider.strip().lower() == "moa":
        try:
            from hades_cli.config import load_config as _load_moa_cfg
...
def switch_model(agent, new_model, new_provider, api_key='', base_url='', api_mode=''):
    ...
    if hasattr(agent, "context_compressor") and agent.context_compressor:
        ...
        try:
            from hades_cli.config import load_config, get_compatible_custom_providers
            _sm_cfg = load_config()
    ...
    try:
        ...
        from hades_cli.config import load_config as _sm_load_config
...
def invoke_tool(agent, function_name: str, function_args: dict, effective_task_id: str,
    ...
    try:
        from hades_cli.middleware import apply_tool_request_middleware
