...
Storage
-------
Bundles live in ``~/.hades/skill-bundles/*.yaml`` (and the equivalent
profile-aware directory under ``HADES_HOME``). Each file looks like::
...
def _bundles_dir() -> Path:
    """Return the canonical bundles directory under HADES_HOME.
