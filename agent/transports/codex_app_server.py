...
projection into Hades' display, approval bridging, transcript projection into
...
"codex_app_server"`. Hades' default tool dispatch is unchanged when this
