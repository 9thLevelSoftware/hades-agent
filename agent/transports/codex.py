...
from agent.reasoning_translators import translate_codex_reasoning_effort
...
class ResponsesApiTransport(ProviderTransport):
    ...
    def build_kwargs(
        ...
        **params,
        ...
        reasoning_effort = translate_codex_reasoning_effort(
            model,
            reasoning_effort,
        ...
        # that would silently route around Hades's web-provider config and
        ...
        # native search engine for xAI sessions instead of Hades's
        # configured web provider (Tavily/etc.), and those results bypass
        # Hades's tool-trace / citation plumbing (they arrive baked into the
