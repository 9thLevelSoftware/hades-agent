...
Activation is handled by the Hades plugin system — standalone plugins only
...
Required env vars (set via ``hermes tools`` or ~/.hades/.env):
...
def _get_langfuse() -> Optional[Langfuse]:
    ...
    Activation of this plugin is controlled by the Hades plugin system —
