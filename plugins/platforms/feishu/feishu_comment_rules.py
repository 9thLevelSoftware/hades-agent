...
Config: ~/.hades/feishu_comment_rules.json (mtime-cached, hot-reload).
Pairing store: ~/.hades/feishu_comment_pairing.json.
"""
...
# ---------------------------------------------------------------------------
#
# Uses the canonical ``get_hades_home()`` helper (HADES_HOME-aware and
...
RULES_FILE = get_hades_home() / "feishu_comment_rules.json"
PAIRING_FILE = get_hades_home() / "feishu_comment_pairing.json"
