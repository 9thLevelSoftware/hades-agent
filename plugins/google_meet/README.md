...
Let the hades agent join a Google Meet call, transcribe it, optionally speak
...
| `node/registry.py` | v3: `$HADES_HOME/workspace/meetings/nodes.json` |
...
echo 'OPENAI_API_KEY=sk-...' >> ~/.hades/.env
