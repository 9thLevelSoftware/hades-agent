...
session-scoped state file under ``$HADES_HOME/workspace/meetings/.active.json``
...
# File + directory layout (under $HADES_HOME):
#
#   workspace/meetings/
...
def _root() -> Path:
    return Path(get_hades_home()) / "workspace" / "meetings"
