...
# The loopback redirect registered for the Hades OAuth client. IP-literal so
...
_DEFAULT_CLIENT_ID = "hades-agent"
...
_CALLBACK_HTML = (
    ...
    b"<div>Connected to Honcho. You can close this tab and return to Hades.</div>"
)
...
def start_loopback_flow_background(
    *,
    ...
    # the request, where a context-local HADES_HOME override can't reach.
