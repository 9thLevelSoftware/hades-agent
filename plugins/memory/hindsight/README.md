...
Daemon startup logs: `~/.hades/logs/hindsight-embed.log`
...
Config file: `~/.hades/hindsight/config.json`
...
The LLM API key is stored in `~/.hades/.env` as `HINDSIGHT_LLM_API_KEY`.
