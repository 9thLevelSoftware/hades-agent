...
request omits ``thinking``.  Hades' ``reasoning_config = {"enabled": False}``
...
:meth:`ZaiProfile.build_api_kwargs_extras` translates the Hades reasoning
...
(per Z.AI / BigModel docs).  Hades' richer effort scale is collapsed onto
