...
Storage path:
- `~/.hades/plugins/hermes-achievements/scan_snapshot.json`
...
Checkpoint file (new):
- `~/.hades/plugins/hermes-achievements/scan_checkpoint.json`
...
- persisted runtime files:
  - `~/.hades/plugins/hermes-achievements/state.json` (existing unlock state)
  - `~/.hades/plugins/hermes-achievements/scan_snapshot.json` (new)
  - `~/.hades/plugins/hermes-achievements/scan_checkpoint.json` (new)
