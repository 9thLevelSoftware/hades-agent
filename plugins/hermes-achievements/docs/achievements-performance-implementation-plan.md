...
- Snapshot persisted at `~/.hades/plugins/hermes-achievements/scan_snapshot.json`.
...
Acceptance:
- Checkpoint persisted at `~/.hades/plugins/hermes-achievements/scan_checkpoint.json`.
