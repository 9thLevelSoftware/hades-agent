...
LEGACY_AUTHOR_MAP = {
    ...
    "agent@local": "9thLevelSoftware",  # local Hades Agent commits in PR branches
    ...
    "sunsky.lau@gmail.com": "liuhao1024",  # PR #56993 salvage (gateway: process-level HADES_HOME for pid/lock/status identity files; #56986)
    ...
    "me@keslerm.com": "keslerm",  # PR #3459 salvage (gateway: 'log' tool_progress mode — silent in chat, tool calls appended to ~/.hades/logs/tool_calls.log via rotating handler; duplicate of #3458 by @dlkakbs who submitted 4 min earlier — both credited)
    ...
    "58116817+TurgutKural@users.noreply.github.com": "TurgutKural",  # salvage of #23356 (HADES_HOME inject)
    ...
    "2663402852@qq.com": "x1am1",  # PR #35098 (chown root-owned top-level HADES_HOME state files)
...
def generate_changelog(commits, tag_name, semver, repo_url="https://github.com/9thLevelSoftware/hades-agent",
...
def main():
    ...
    print(f"{'='*60}")
    print("  Hades Agent Release Preview")
    print(f"{'='*60}")
