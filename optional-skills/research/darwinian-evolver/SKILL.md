...
import upstream classes into Hades itself.
...
Open `~/.hades/cache/darwinian-evolver/darwinian_evolver/darwinian_evolver/lineage_visualizer.html`
...
7. **AGPL.** Never `from darwinian_evolver import ...` inside Hermes core.
   Custom driver scripts under `~/.hades/skills/...` are user-side and fine.
