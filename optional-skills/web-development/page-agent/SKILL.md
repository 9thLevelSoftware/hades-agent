...
- User wants **Hermes itself to drive a browser** → use Hades' built-in browser tool (Browserbase / Camofox). page-agent is the *opposite* direction.
