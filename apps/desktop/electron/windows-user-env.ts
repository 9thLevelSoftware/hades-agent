...
// even though a fresh shell — and the Hades CLI — sees it immediately. The
// desktop's HADES_HOME resolution relies on process.env, so that stale-snapshot
...
//       HADES_HOME    REG_SZ    F:\Hermes\data
//
