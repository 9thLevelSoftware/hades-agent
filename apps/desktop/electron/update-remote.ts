 ...
 *
 * A public install can end up with `origin=git@github.com:9thLevelSoftware/hades-agent.git`.
...
const OFFICIAL_REPO_HTTPS_URL = 'https://github.com/9thLevelSoftware/hades-agent.git'
