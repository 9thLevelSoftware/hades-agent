...
export interface EnvVarInfo {
  ...
  // in hades_cli/provider_catalog.py). When present, the Keys tab groups by
...
// folders. Mirrors hades_cli/projects_db.Project.to_dict().
...
export interface SkillInfo {
  ...
  usage?: number
  /** 'agent' = learned/local (editable), 'bundled' = ships with Hades, 'hub' = installed. */
