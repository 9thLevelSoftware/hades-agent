...
// /api/profiles/active `current`). "default" is the root ~/.hades. This is the
...
// Persist the choice and relaunch the backend under the new HADES_HOME. The
...
// Switch to the default (root ~/.hades) profile — bound to ⌘1.
