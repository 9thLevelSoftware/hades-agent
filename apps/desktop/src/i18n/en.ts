...
export const en: Translations = {
  ...
  settings: {
    ...
    gateway: {
      ...
      remoteDesc: 'Connect this desktop shell to a remote Hades backend.',
      remoteAuthHint: 'Hosted gateways use OAuth or a username and password; self-hosted ones may use a session token.',
      cloudTitle: 'Hermes Cloud',
      cloudDesc: 'Sign in once to Hades Cloud and pick from the agents on your account — no URL to paste.',
      cloudSignInTitle: 'Hermes Cloud',
      cloudSignIn: 'Sign in to Hades Cloud',
      cloudSignedIn: 'Signed in to Hades Cloud',
      cloudNeedsSignIn: 'Sign in to Hades Cloud to discover the agents on your account.',
      ...
      cloudSignedOutTitle: 'Signed out of Hades Cloud',
      cloudSignedOutMessage: 'Cleared the Hades Cloud session.',
      ...
      restartingMessage: 'Hades Desktop will reconnect using the saved settings — the shell stays open.',
  ...
  sidebar: {
    ...
    projects: {
      ...
      staleBackend:
        'Update the Hades backend to create projects — your backend is older than this desktop app (Settings → Updates → Backend).',
  ...
  install: {
    ...
    failedDesc:
      'One of the install steps failed. On Windows, this can happen if another Hades CLI or desktop instance is running. Stop any running Hermes instances, then retry. Check the details below or the desktop log for the full transcript.',
    activeDesc:
  ...
  assistant: {
    ...
    approval: {
      ...
      alwaysDescription: pattern =>
        `This adds the “${pattern}” pattern to your permanent allowlist (~/.hades/config.yaml). Hermes won’t ask again for commands like this — in this session or any future one.`,
