...
def expand_whatsapp_aliases(identifier: str) -> Set[str]:
    ...
    bridge's ``$HADES_HOME/whatsapp/session/lid-mapping-*.json`` files,
    ...
    session_dir = get_hades_dir("platforms/whatsapp/session", "whatsapp/session")
...
def canonical_whatsapp_identifier(identifier: str) -> str:
    ...
    bookkeeping lines up with Hades' session bookkeeping even when
