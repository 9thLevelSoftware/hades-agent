...
const BUILTIN_NAV_REST: NavItem[] = [
  ...
  { path: "/receipts", label: "Receipts", icon: ShieldCheck },
  ...
  { path: "/autonomy", label: "Autonomy", icon: Shield },
  ...
  return (
    ...
    <ConfirmDialog
      ...
      description={
        ...
        "This restarts the Hades gateway process. Connected channels and active sessions will reconnect afterward."
      }
