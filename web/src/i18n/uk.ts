...
export const uk: Translations = {
  ...
  pluginsPage: {
    ...
    removeConfirm: "Видалити цей плагін з ~/.hades/plugins/?",
    removeHint: "Видаляти можна лише плагіни, встановлені користувачем у ~/.hades/plugins.",
  ...
  skills: {
    ...
    filters: "Фільтри",
    noSkills: "Навичок не знайдено. Навички завантажуються з ~/.hades/skills/",
