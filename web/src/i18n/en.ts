...
export const en: Translations = {
  ...
  pluginsPage: {
    ...
    removeConfirm: "Remove this plugin from ~/.hades/plugins/?",
    removeHint: "Only user-installed plugins under ~/.hades/plugins can be removed.",
  ...
  skills: {
    ...
    filters: "Filters",
    noSkills: "No skills found. Skills are loaded from ~/.hades/skills/",
