 ...
 *
 * Values mirror hades_constants.VALID_REASONING_EFFORTS plus `none`
 * (thinking-off). An empty/unset config value means the Hades default,
 * which is `medium`.
 */
 ...
 *  option. Empty/unknown → `medium` (Hades' default when unset). */
