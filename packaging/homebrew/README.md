Homebrew packaging notes for Hades Agent.
...
- The wrapper exports `HADES_BUNDLED_SKILLS`, `HADES_OPTIONAL_SKILLS`, and `HERMES_MANAGED=homebrew` so packaged installs keep runtime assets and defer upgrades to Homebrew.
