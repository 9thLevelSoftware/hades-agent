...
convention. State lives in the per-profile ``$HADES_HOME/projects.db`` store
(see :mod:`hades_cli.projects_db`).
...
def build_parser(
    ...
    p_create.add_argument("name", help="Human name, e.g. 'Hades Agent'")
