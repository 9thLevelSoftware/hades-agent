...
from hades_cli.config import cfg_get, load_config, save_config
from hades_cli.colors import Colors, color
from hades_cli.platforms import PLATFORMS as _PLATFORMS
