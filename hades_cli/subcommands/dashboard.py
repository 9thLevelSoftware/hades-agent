...
def build_dashboard_parser(
    ...
    # browser. It exists so the Hades Desktop app (and headless remote
    ...
    # client with Nous Portal and write the client_id into ~/.hades/.env.
    ...
    dashboard_register_parser = dashboard_subparsers.add_parser(
        ...
        description=(
            ...
            "HERMES_DASHBOARD_OAUTH_CLIENT_ID into ~/.hades/.env, and prints "
