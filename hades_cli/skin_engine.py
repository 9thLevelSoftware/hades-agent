"""Hades CLI skin/theme engine.

A data-driven skin system that lets users customize the CLI's visual appearance.
Skins are defined as YAML files in ~/.hades/skins/ or as built-in presets.
...
.. code-block:: python
    ...
    from hades_cli.skin_engine import get_active_skin, list_skins, set_active_skin
    ...
    set_active_skin("mytheme")            # Switch to user skin from ~/.hades/skins/
...
Drop a YAML file in ``~/.hades/skins/<name>.yaml`` following the schema above.
...
_BUILTIN_SKINS: Dict[str, Dict[str, Any]] = {
    "default": {
        ...
        "spinner": {
            ...
            "thinking_faces": ["(Ω)", "(⛧)", "(◆)", "(⌁)", "(⬥)"],
            "thinking_verbs": [
                "descending", "consulting the shades", "weighing the soul",
                "crossing the Styx", "judging the dead", "opening the gate",
                "invoking the depths", "binding the compact",
            ],
            "wings": [
                ["⟪Ω", "Ω⟫"],
                ["⟪⛧", "⛧⟫"],
        ...
        "branding": {
            ...
            "goodbye": "Return to the surface. Ω",
            "response_label": " Ω Hades ",
            "prompt_symbol": "Ω",
            "help_header": "(Ω) Available Commands",
        },
        "tool_prefix": "╎",
        "banner_logo": """[bold #EDE9FE]██╗  ██╗ █████╗ ██████╗ ███████╗███████╗       █████╗  ██████╗ ███████╗███╗   ██╗████████╗[/]
[bold #C084FC]██║  ██║██╔══██╗██╔══██╗██╔════╝██╔════╝      ██╔══██╗██╔════╝ ██╔════╝████╗  ██║╚══██╔══╝[/]
[#A855F7]███████║███████║██║  ██║█████╗  ███████╗█████╗███████║██║  ███╗█████╗  ██╔██╗ ██║   ██║[/]
[#A78BFA]██╔══██║██╔══██║██║  ██║██╔══╝  ╚════██║╚════╝██╔══██║██║   ██║██╔══╝  ██║╚██╗██║   ██║[/]
[#9333EA]██║  ██║██║  ██║██████╔╝███████╗███████║      ██║  ██║╚██████╔╝███████╗██║ ╚████║   ██║[/]
...
[dim #4A4A4A]⠀⠀⠀⠀⠀⠀⠀⠀⠀the boulder⠀⠀⠀⠀⠀⠀⠀⠀⠀[/]""",
    ...
    "hades": {
        "name": "hades",
        "description": "Underworld sovereign — obsidian, brimstone, and stygian violet",
        "colors": {
            "banner_border": "#9333EA",
            "banner_title": "#C084FC",
            "banner_accent": "#A855F7",
            ...
            "session_border": "#9F7AC4",
            "selection_bg": "#4C1D95",
            "completion_menu_bg": "#2A1848",
            "completion_menu_current_bg": "#4C1D95",
            "completion_menu_meta_bg": "#2A1848",
            "completion_menu_meta_current_bg": "#6D28D9",
        },
        "spinner": {
            "waiting_faces": ["(Ω)", "(⛧)", "(◆)", "(⬥)", "(/)"],
            "thinking_faces": ["(Ω)", "(⛧)", "(◆)", "(⌁)", "(⬥)"],
