...
Storage: ``fallback_providers`` in ``~/.hades/config.yaml`` (top-level, list of
...
def _restore_auth_active_provider(value: Any) -> None:
    ...
    try:
        from hades_cli.auth import _auth_store_lock, _load_auth_store, _save_auth_store
...
def cmd_fallback_add(args) -> None:
    ...
    from hades_cli.main import _require_tty, select_provider_and_model
