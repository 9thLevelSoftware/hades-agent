"""Prompt helpers for Hades workflow agent-task cells.
...
from hades_cli.workflows_engine import render_template
from hades_cli.workflows_redaction import SENSITIVE_KEY_RE, redact_sensitive
