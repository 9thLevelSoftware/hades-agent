"""
Security advisory checker for Hades Agent.
...
run in environments where the rest of Hades failed to import.
"""
...
ADVISORIES: tuple[Advisory, ...] = (
    Advisory(
        ...
        remediation=(
            ...
            "Rotate API keys in ~/.hades/.env (OpenRouter, Anthropic, OpenAI, "
...
# ``~/.hades/cache/advisory_banner_seen`` (a single line per advisory ID:
