...
Import discipline mirrors ``hades_cli.cli_commands_mixin``:
...
class CLIBillingMixin:
    ...
    def _subscription_preview_and_confirm(self, state, tier_id, *, allow_stepup=True):
        ...
        from hades_cli.nous_billing import BillingError, BillingScopeRequired, post_subscription_preview
    ...
    def _subscription_handle_scope_required(self, state, *, retry, idempotency_key=None):
        ...
        try:
            from hades_cli import nous_billing as _nb
