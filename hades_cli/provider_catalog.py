...
they were not: the CLI picker read :data:`hades_cli.models.CANONICAL_PROVIDERS`
...
* ``auth_type`` / ``api_key_env_vars`` / ``base_url_env_var`` from
  :data:`hades_cli.auth.PROVIDER_REGISTRY` (credential truth), and
...
# hades_cli.auth.PROVIDER_REGISTRY and providers.base.ProviderProfile.
