...
This validates the IPC + lifecycle story that mocks can't:
  ...
  - the child process resolves hades_cli.kanban_db on its own
  ...
  - worker logs are captured to HADES_HOME/kanban/logs/<task>.log
