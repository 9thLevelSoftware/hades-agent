...
class TestCuaEnvironmentScrubbing:
    ...
    def test_cua_session_sanitizes_provider_env_vars(self):
        ...
        The cua-driver MCP subprocess should not inherit Hades-managed
...
class TestClickButtonPassthrough:
    """Surface 5 (9thLevelSoftware/hades-agent#47072) — `middle_click` must
...
class TestImageMimeTypePropagation:
    """Surface 7 (9thLevelSoftware/hades-agent#47072): trycua/cua#1961 made
...
class TestMcpInvocationResolution:
    """Surface 8 (9thLevelSoftware/hades-agent#47072): instead of hardcoding
...
class TestStructuredElementsConsumption:
    """Surface 2 (9thLevelSoftware/hades-agent#47072): trycua/cua#1961 made
...
class TestCapabilityDiscovery:
    """Surface 4 (9thLevelSoftware/hades-agent#47072): the wrapper learns
...
class TestElementTokenAttachment:
    """Surface 6 (9thLevelSoftware/hades-agent#47072): trycua/cua#1961 added
