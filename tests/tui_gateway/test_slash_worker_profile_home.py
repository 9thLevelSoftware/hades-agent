...
def test_slash_worker_accepts_profile_home():
    ...
    with patch.dict("sys.modules", {
        ...
        with patch("subprocess.Popen") as mock_popen:
            ...
            # Check that HADES_HOME was set in the environment
            call_kwargs = mock_popen.call_args[1]
            assert "env" in call_kwargs
            assert call_kwargs["env"]["HADES_HOME"] == "/home/luke/.hermes/profiles/work"
...
def test_slash_worker_without_profile_home():
    ...
    with patch.dict("sys.modules", {
        ...
        with patch("subprocess.Popen") as mock_popen:
            ...
            # Check that HADES_HOME was NOT overridden
            call_kwargs = mock_popen.call_args[1]
            assert "env" in call_kwargs
            # HADES_HOME should be from parent env or undefined (inherited from os.environ)
...
def test_slash_worker_with_none_profile_home():
    ...
    with patch.dict("sys.modules", {
        ...
        with patch("subprocess.Popen") as mock_popen:
            ...
            # Check that HADES_HOME was NOT set
            call_kwargs = mock_popen.call_args[1]
            env = call_kwargs["env"]
            # When profile_home is None, HADES_HOME should come from parent env only
            if "HADES_HOME" in env:
