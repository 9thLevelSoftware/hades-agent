...
The fix writes snapshots under ``~/.hades/sessions/saved/`` and prints
...
def hermes_home(tmp_path, monkeypatch):
    ...
    if hasattr(hermes_constants, "_hermes_home_cache"):
        hades_constants._hermes_home_cache = None
    return home
...
def test_save_conversation_writes_under_hermes_home(hermes_home, tmp_path, monkeypatch, capsys):
    ...
    # File MUST be under ~/.hades/sessions/saved/
