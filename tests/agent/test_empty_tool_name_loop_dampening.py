...
@pytest.fixture()
def agent_env():
    """Spin up the mock provider + an isolated HADES_HOME, yield (agent, helpers)."""
    ...
    os.makedirs(os.path.join(test_home, ".hades"))
    prev_home = os.environ.get("HADES_HOME")
    os.environ["HADES_HOME"] = os.path.join(test_home, ".hades")
    ...
    try:
        ...
        if prev_home is None:
            ...
            os.environ["HADES_HOME"] = prev_home
