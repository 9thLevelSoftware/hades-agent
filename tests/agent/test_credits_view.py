...
from hades_cli.nous_account import NousPortalAccountInfo, NousPaidServiceAccessInfo
...
def test_view_logged_out_when_no_token(monkeypatch):
    monkeypatch.setattr("hades_cli.auth.get_provider_auth_state", lambda provider: {})
...
def test_view_fetch_failure_is_logged_out(monkeypatch):
    ...
    monkeypatch.setattr("hades_cli.nous_account.get_nous_portal_account_info", _boom)
...
def test_credits_command_fully_removed():
    ...
    from hades_cli.commands import resolve_command, COMMAND_REGISTRY
