...
Note: Tests that import ``hades_cli.auth`` or ``hades_cli.runtime_provider``
...
class TestResolveProvider:
    ...
    def test_auto_detect_with_aws_credentials(self, monkeypatch):
        ...
        with patch("hades_cli.auth._load_auth_store", return_value={}):
...
class TestRuntimeProvider:
    ...
    def test_bedrock_runtime_resolution(self, monkeypatch):
        ...
        with patch("hades_cli.runtime_provider.resolve_provider", return_value="bedrock"), \
             patch("hades_cli.runtime_provider._get_model_config", return_value={"provider": "bedrock"}):
    ...
    def test_bedrock_runtime_no_credentials_raises_on_auto_detect(self, monkeypatch):
        ...
        with patch("hades_cli.runtime_provider.resolve_provider", return_value="bedrock"), \
             patch("hades_cli.runtime_provider._get_model_config", return_value={"provider": "bedrock"}), \
             patch("hades_cli.runtime_provider.resolve_requested_provider", return_value="auto"), \
...
class TestProvidersModule:
    ...
    def test_bedrock_alias_in_providers(self):
        from hades_cli.providers import ALIASES
