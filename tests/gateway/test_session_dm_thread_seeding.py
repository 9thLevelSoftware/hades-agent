...
def store(tmp_path, monkeypatch):
    ...
    ~/.hades/state.db. (DEFAULT_DB_PATH is a module-level constant computed
    at hermes_state import time, before pytest's HADES_HOME monkeypatch
    fires — the autouse fixture's HADES_HOME override doesn't help here.)
    """
    import hades_state
