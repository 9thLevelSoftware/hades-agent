"""Preregistered compensation_boundary cases through the real transaction stack.
...
def benchmark_base(tmp_path_factory):
    return tmp_path_factory.mktemp(f"tx-compensation_boundary")
