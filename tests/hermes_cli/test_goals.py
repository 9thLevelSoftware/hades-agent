...
def hermes_home(tmp_path, monkeypatch):
    """Isolated HADES_HOME so SessionDB.state_meta writes don't clobber the real one."""
    ...
    # Bust the goal-module's DB cache for each test so it re-resolves HADES_HOME.
    from hades_cli import goals
...
class TestParseJudgeResponse:
    def test_clean_json_done(self):
        from hades_cli.goals import _parse_judge_response
...
def test_goal_command_dispatches_in_cli_registry_helpers():
    ...
    from hades_cli.commands import COMMANDS, COMMANDS_BY_CATEGORY
...
class TestJudgeParseFailureAutoPause:
    ...
    def test_auto_pause_after_three_consecutive_parse_failures(self, hermes_home):
        ...
        from hades_cli import goals
        from hades_cli.goals import GoalManager, DEFAULT_MAX_CONSECUTIVE_PARSE_FAILURES
    ...
    def test_consecutive_parse_failures_persists_across_goalmanager_reloads(
        ...
        from hades_cli import goals
        from hades_cli.goals import GoalManager, load_goal
...
class TestGoalStateSubgoalsBackcompat:
    def test_old_state_meta_row_loads_without_subgoals(self):
        ...
        from hades_cli.goals import GoalState
...
class TestMigrateGoalToSession:
    ...
    def test_migrates_active_goal_to_child(self, hermes_home):
        from hades_cli.goals import save_goal, load_goal, migrate_goal_to_session, GoalState
    ...
    def test_no_goal_to_migrate_returns_false(self, hermes_home):
        from hades_cli.goals import migrate_goal_to_session, load_goal
    ...
    def test_same_id_is_noop(self, hermes_home):
        from hades_cli.goals import save_goal, migrate_goal_to_session, GoalState
    ...
    def test_cleared_goal_not_migrated(self, hermes_home):
        from hades_cli.goals import save_goal, clear_goal, migrate_goal_to_session, load_goal, GoalState
...
class TestGoalContractSerialization:
    def test_roundtrip_with_contract(self):
        from hades_cli.goals import GoalState, GoalContract
    ...
    def test_render_block_omits_empty_fields(self):
        from hades_cli.goals import GoalContract
...
class TestGoalManagerContract:
    def test_set_with_contract(self, hermes_home):
        from hades_cli.goals import GoalManager, GoalContract
    ...
    def test_set_contract_after_the_fact(self, hermes_home):
        ...
        assert mgr.has_contract()
        # Survives reload.
        from hades_cli.goals import GoalManager as GM2
