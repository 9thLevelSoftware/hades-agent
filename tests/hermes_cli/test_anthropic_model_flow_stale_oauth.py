...
when a stale ANTHROPIC_TOKEN exists in ~/.hades/.env but no valid
...
class TestStaleOAuthTokenDetection:
    ...
    def test_stale_oauth_token_triggers_reauth(self, tmp_path, monkeypatch, capsys):
        ...
        monkeypatch.setattr("hades_cli.secret_prompt.masked_secret_prompt", lambda _: "")

        from hades_cli.main import _model_flow_anthropic
        cfg = {}
