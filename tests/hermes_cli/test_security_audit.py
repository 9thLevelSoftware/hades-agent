"""Unit tests for hades_cli.security_audit — parsers + OSV plumbing.
...
from hades_cli import security_audit as sa
...
class TestExitCodes:
    ...
    def test_clean_audit_exits_zero(self, tmp_path: Path, monkeypatch, capsys):
        monkeypatch.setattr(sa, "get_hades_home", lambda: str(tmp_path))
