...
from hades_cli.dashboard_auth import prefix as prefix_mod
...
class TestPublicUrlOverride:
    ...
    def patch_config(self, monkeypatch):
        """Replace ``hades_cli.config.load_config`` with a stub
        ...
        def _set(public_url) -> None:
            ...
            monkeypatch.setattr(
                "hades_cli.config.load_config", lambda: cfg
            )
...
class TestCookiePathRespectsPrefix:
    ...
    def test_loopback_cookies_unprefixed(self):
        ...
        from hades_cli.dashboard_auth.cookies import set_pkce_cookie
