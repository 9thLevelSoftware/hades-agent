...
The CLI picker (``hades_cli.main.select_provider_and_model``) builds its
...
def config_home(tmp_path, monkeypatch):
    ...
    monkeypatch.delenv("HADES_INFERENCE_PROVIDER", raising=False)
...
def test_cli_picker_hides_excluded_provider_by_alias(config_home):
    ...
    from hades_cli.models import _PROVIDER_ALIASES, CANONICAL_PROVIDERS
