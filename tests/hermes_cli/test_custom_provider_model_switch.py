...
def config_home(tmp_path, monkeypatch):
    """Isolated HADES_HOME with a minimal config."""
    home = tmp_path / "hades"
    home.mkdir()
...
class TestCustomProviderModelSwitch:
    ...
    def test_custom_endpoint_switch_prunes_stale_model_config_pool_entry(
        ...
        from hades_cli.main import _model_flow_custom
        ...
        with patch(
            ...
            return_value={
             ...
             patch("hades_cli.secret_prompt.masked_secret_prompt", return_value="sk-new"), \
             patch("hades_cli.main._prompt_custom_api_mode_selection", return_value=""), \
             patch(
                 "builtins.input",
                 side_effect=[
    ...
    def test_saved_model_still_probes_endpoint(self, config_home):
        ...
        with patch("hades_cli.models.fetch_api_models", return_value=["model-A", "model-B"]) as mock_fetch, \
             patch("hades_cli.curses_ui.curses_radiolist", side_effect=ImportError), \
    ...
    def test_can_switch_to_different_model(self, config_home):
        ...
        with patch("hades_cli.models.fetch_api_models", return_value=["model-A", "model-B"]), \
             patch("hades_cli.curses_ui.curses_radiolist", side_effect=ImportError), \
             patch("builtins.input", return_value="2"), \
             patch("builtins.print"):
            _model_flow_named_custom({}, provider_info)
    ...
    def test_probe_failure_falls_back_to_saved(self, config_home):
        ...
        with patch("hades_cli.models.fetch_api_models", return_value=[]), \
    ...
    def test_no_saved_model_still_works(self, config_home):
        ...
        with patch("hades_cli.models.fetch_api_models", return_value=["model-X"]), \
             patch("hades_cli.curses_ui.curses_radiolist", side_effect=ImportError), \
    ...
    def test_api_mode_set_from_provider_info(self, config_home):
        ...
        with patch("hades_cli.models.fetch_api_models", return_value=["claude-3"]) as mock_fetch, \
             patch("hades_cli.curses_ui.curses_radiolist", side_effect=ImportError), \
             patch("builtins.input", return_value="1"), \
             patch("builtins.print"):
            _model_flow_named_custom({}, provider_info)
    ...
    def test_api_mode_cleared_when_not_specified(self, config_home):
        ...
        with patch("hades_cli.models.fetch_api_models", return_value=["llama-3"]), \
             patch("hades_cli.curses_ui.curses_radiolist", side_effect=ImportError), \
             patch("builtins.input", return_value="1"), \
             patch("builtins.print"):
            _model_flow_named_custom({}, provider_info)
    ...
    def test_env_template_api_key_is_preserved_in_model_config(self, config_home, monkeypatch):
        ...
        with patch("hades_cli.models.fetch_api_models", return_value=["qwen3.6-35b-fast"]) as mock_fetch, \
             patch("hades_cli.curses_ui.curses_radiolist", side_effect=ImportError), \
             patch("builtins.input", return_value="1"), \
             patch("builtins.print"):
            _model_flow_named_custom({}, provider_info)
    ...
    def test_key_env_custom_provider_persists_reference_not_secret(self, config_home, monkeypatch):
        ...
        with patch("hades_cli.models.fetch_api_models", return_value=["qwen3.6-35b-fast"]), \
             patch("hades_cli.curses_ui.curses_radiolist", side_effect=ImportError), \
             patch("builtins.input", return_value="1"), \
             patch("builtins.print"):
            _model_flow_named_custom({}, provider_info)
    ...
    def test_env_ref_base_url_preserves_api_key_ref_through_picker(
        ...
        with patch("hades_cli.main._prompt_provider_choice",
                   side_effect=_pick_neuralwatt), \
             patch("hades_cli.models.fetch_api_models",
...
class TestCustomProviderDiscoverModels:
    ...
    def test_discover_false_uses_configured_list_and_skips_probe(self, config_home):
        ...
        with patch("hades_cli.models.fetch_api_models") as mock_fetch, \
             patch("hades_cli.curses_ui.curses_radiolist", side_effect=ImportError), \
             patch("builtins.input", return_value="2"), \
             patch("builtins.print"):
            _model_flow_named_custom({}, provider_info)
