...
class TestSaveDisabledSkills:
    @patch("hades_cli.skills_config.save_config")
    def test_saves_global_sorted(self, mock_save):
        from hades_cli.skills_config import save_disabled_skills
        config = {}
...
class TestIsSkillDisabled:
    @patch("hades_cli.config.load_config")
...
class TestGetCategories:
    def test_extracts_unique_categories(self):
        from hades_cli.skills_config import _get_categories
        skills = [
