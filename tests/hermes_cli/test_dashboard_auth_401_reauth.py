...
from hades_cli.dashboard_auth.base import ProviderError, RefreshExpiredError
from hades_cli.dashboard_auth.cookies import (
    SESSION_AT_COOKIE,
...
class TestTransparentRefreshOnAccessTokenEviction:
    ...
    def _build_rt_only_app(self):
        ...
        """
        import time as _t
        from tests.hades_cli.conftest_dashboard_auth import _sign
...
class TestAutoSsoRedirect:
    ...
    from hades_cli.dashboard_auth.cookies import SSO_ATTEMPT_COOKIE
    ...
    def test_multiple_providers_render_chooser_not_auto_sso(self, gated_app):
        ...
        from tests.hades_cli.conftest_dashboard_auth import StubAuthProvider
        from hades_cli.dashboard_auth import register_provider
...
class TestNextSameOriginValidation:
    ...
    def test_safe_next_validator_accepts_same_origin(self):
        from hades_cli.dashboard_auth.middleware import _safe_next_target
...
class TestValidatePostLoginTarget:
    ...
    def test_accepts_same_origin_paths(self):
        from hades_cli.dashboard_auth.routes import _validate_post_login_target
...
class TestRenderLoginHtmlNext:
    ...
    def test_no_next_emits_plain_button(self):
        from hades_cli.dashboard_auth.login_page import render_login_html
