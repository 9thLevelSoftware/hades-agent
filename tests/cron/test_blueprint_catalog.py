...
the docs generator. Uses an isolated HADES_HOME for anything that touches the
cron job store.
"""
...
class TestCommandHandler:
    ...
    def test_name_match_is_forgiving(self, isolated_home):
        from hades_cli.blueprint_cmd import handle_blueprint_command, match_blueprint
