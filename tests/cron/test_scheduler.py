...
class TestPerJobToolsetMcpMerge:
    ...
    def test_resolver_empty_per_job_falls_through_to_platform(self):
        ...
        with patch("hades_cli.tools_config._get_platform_tools",
...
class TestRunJobSessionPersistence:
    def test_run_job_passes_session_db_and_cron_platform(self, tmp_path):
        ...
        with patch("cron.scheduler._hermes_home", tmp_path), \
             ...
             patch("hades_cli.env_loader.load_hermes_dotenv"), \
             patch("hades_cli.env_loader.reset_secret_source_cache"), \
             patch("hades_state.SessionDB", return_value=fake_db), \
             patch(
    ...
    def test_run_job_enabled_toolsets_resolves_from_platform_config_when_not_set(self, tmp_path):
        ...
        # The cron default is _HADES_CORE_TOOLS with _DEFAULT_OFF_TOOLSETS
    ...
    def test_run_job_per_job_toolsets_win_over_platform_config(self, tmp_path):
        ...
        extra = [patch("hades_cli.tools_config._get_platform_tools", return_value={"web", "file"})]
    ...
    def test_run_job_sets_auto_delivery_env_from_dotenv_home_channel(self, tmp_path, monkeypatch):
        ...
        assert os.getenv("HADES_CRON_AUTO_DELIVER_PLATFORM") is None
        assert os.getenv("HADES_CRON_AUTO_DELIVER_CHAT_ID") is None
        assert os.getenv("HADES_CRON_AUTO_DELIVER_THREAD_ID") is None
        fake_db.close.assert_called_once()
    ...
    def test_run_job_resets_secret_source_cache_before_reload(self, tmp_path, monkeypatch):
        ...
        this HADES_HOME in ``_APPLIED_HOMES``, so the external-secret pull
        ...
        with patch("cron.scheduler._hermes_home", tmp_path), \
             patch("cron.scheduler._resolve_origin", return_value=None), \
             patch("hades_cli.env_loader.reset_secret_source_cache", _record_reset), \
             patch("hades_cli.env_loader.load_hermes_dotenv", _record_load), \
             patch("hades_state.SessionDB", return_value=fake_db), \
             patch(
                 "hades_cli.runtime_provider.resolve_runtime_provider",
                 return_value={
