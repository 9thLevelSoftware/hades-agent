...
Run from the PR worktree:
    ...
    cd ~/.hades/hermes-agent/.worktrees/browser-providers-plugin
...
# checkout lives two levels up at ``~/.hades/hermes-agent``.
MAIN_DIR = REPO_ROOT.parent.parent  # ~/.hades/hermes-agent
...
# Isolated HADES_HOME for the config write.
