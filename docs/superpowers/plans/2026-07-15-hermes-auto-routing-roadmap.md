...
- Use real imports and a temporary `HADES_HOME` for integration tests. Mock only provider/network completion boundaries, clock/randomness, and process interruption.
