...
- **مہارتیں (Skills)** — صارف کی بنائی گئی مہارتیں → `~/.hades/skills/openclaw-imports/`
...
- 🐛 [مسائل (Issues)](https://github.com/9thLevelSoftware/hades-agent/issues)
