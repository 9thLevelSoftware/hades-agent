#!/usr/bin/env python3
"""
SWE Runner with Hades Trajectory Format
...
- Outputs trajectories in Hades format (from/value pairs with <tool_call>/<tool_response> XML)
...
# ============================================================================
# Mini-SWE Runner with Hades Trajectory Format
# ============================================================================

class MiniSWERunner:
    """
    Agent runner that uses Hermes-Agent's built-in execution environments
    and outputs trajectories in Hades-Agent format.
    """
    ...
    def _convert_to_hermes_format(
        ...
        """
        Convert internal message format to Hades trajectory format.
...
Complete the user's task step by step."""
        ...
        # Convert to Hades trajectory format
...
def main(
    ...
    """
    Run SWE tasks with Hades trajectory format output.
    ...
    """
    print("🚀 Mini-SWE Runner with Hades Trajectory Format")
    print("=" * 60)
