...
4. 为 token 命名（例如 "Hades Agent"），设置可选的过期时间，然后点击 **Generate Token**
5. 复制 token 并添加到 `~/.hades/.env`：
...
```bash
CANVAS="python $HADES_HOME/skills/productivity/canvas/scripts/canvas_api.py"
