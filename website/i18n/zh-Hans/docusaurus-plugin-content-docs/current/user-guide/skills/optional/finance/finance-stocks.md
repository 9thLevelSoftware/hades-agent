...
```
SCRIPT=~/.hades/skills/finance/stocks/scripts/stocks_client.py
...
```
python3 ~/.hades/skills/finance/stocks/scripts/stocks_client.py quote AAPL
```
