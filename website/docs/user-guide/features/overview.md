...
- **[Batch Processing](batch-processing.md)** — Run the Hades agent across hundreds or thousands of prompts in parallel, generating structured ShareGPT-format trajectory data for training data generation or evaluation.
