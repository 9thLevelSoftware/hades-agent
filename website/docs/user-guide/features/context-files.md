...
Hades Agent automatically discovers and loads context files that shape how it behaves. Some are project-local and discovered from your working directory. `SOUL.md` is now global to the Hades instance and is loaded from `HADES_HOME` only.
...
| **SOUL.md** | Global personality and tone customization for this Hermes instance | `HADES_HOME/SOUL.md` only |
...
- `~/.hades/SOUL.md`
- or `$HADES_HOME/SOUL.md` if you run Hermes with a custom home directory
