...
**Fix**: Add your User ID to `MATTERMOST_ALLOWED_USERS` in `~/.hades/.env` and restart the gateway. Remember: the User ID is a 26-character alphanumeric string, not your `@username`.
