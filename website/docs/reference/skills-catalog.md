...
| [`hermes-workflow-builder`](/docs/user-guide/skills/bundled/autonomous-ai-agents/autonomous-ai-agents-hermes-workflow-builder) | Use when creating, designing, improving, validating, or deploying Hermes Workflow graphs from a user goal. | `autonomous-ai-agents/hermes-workflow-builder` |
...
| [`petdex`](/docs/user-guide/skills/bundled/productivity/productivity-petdex) | Install and select animated petdex mascots for Hades. | `productivity/petdex` |
...
| [`teams-meeting-pipeline`](/docs/user-guide/skills/bundled/productivity/productivity-teams-meeting-pipeline) | Operate the Teams meeting summary pipeline via Hades CLI — summarize meetings, inspect pipeline status, replay jobs, manage Microsoft Graph subscriptions. | `productivity/teams-meeting-pipeline` |
