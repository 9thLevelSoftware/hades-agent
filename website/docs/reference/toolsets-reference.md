...
description: "Reference for Hades core, composite, platform, and dynamic toolsets"
---
...
| `hades-gateway` | Internal gateway orchestrator toolset — union of every `hermes-<platform>` toolset; used when the gateway needs to accept any message source. |
