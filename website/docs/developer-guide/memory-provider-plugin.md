...
class MyMemoryProvider(MemoryProvider):
    ...
    def initialize(self, session_id: str, **kwargs) -> None:
        ...
        kwargs always includes:
          hermes_home (str): Active HADES_HOME path. Use for storage.
        """
...
All storage paths **must** use the `hermes_home` kwarg from `initialize()`, not hardcoded `~/.hades`:
