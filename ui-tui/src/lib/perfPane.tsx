...
//
// Both gate on HERMES_DEV_PERF=1 and dump JSON-lines (default ~/.hades/perf.log,
...
const LOG_PATH = process.env.HERMES_DEV_PERF_LOG?.trim() || join(homedir(), '.hades', 'perf.log')
